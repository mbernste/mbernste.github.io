...
To answer this, let's say we have some positive kernel $K$ and let's fix one of the arguments, $x$, to the kernel and let $K(x, .)$ be only a univariate function with respect to the second argument. Then, we see that
