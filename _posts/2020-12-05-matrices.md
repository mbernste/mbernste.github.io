...
can be thought of as two three-dimensional row vectors (The dotted lines are visualize guides. The colored dotted lines trace each vector to the place $z = 0$. The black colored lines depict the difference between the two vectors on the z=0 place):
...
$$\begin{bmatrix} \color{#0062eb}{1} & \color{#0062eb}{2} & \color{#0062eb}{1} \\ \color{#009930}{0} & \color{#009930}{1} & \color{#009930}{-1}\end{bmatrix}$$
