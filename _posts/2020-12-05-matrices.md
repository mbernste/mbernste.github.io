...
can be thought of as two three-dimensional row vectors (The dotted lines are visualize guides. The colored dotted lines trace each vector to the $$z = 0$$ plane. The black colored lines depict the difference between the two vectors on the $$z=0$$ place):
