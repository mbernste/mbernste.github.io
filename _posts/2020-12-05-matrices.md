...
$$\boldsymbol{A} := \begain{bmatrix} \boldsymbol{a}_{1,*} \\ \boldsymbol{a}_{2,*} \\ \vdots \\ \boldsymbol{a}_{m,*}  \end{bmatrix}$$

Or, as a list of column vectors:

$$\boldsymbol{A} := \begain{bmatrix} \boldsymbol{a}_{*,1} & \boldsymbol{a}_{*,2} & \dots & \boldsymbol{a}_{*,n}\end{bmatrix}$$
