...
In this scenario, each $\psi'(x)_i$ can be interpreted as a new "feature" of $\boldsymbol{x}$ for which dot products on these feature vectors compute inner products in the RKHS. 
