...
For many people I've talked to, Euler's constant $e := 2.71828$ is a somewhat mysterious number one sort of just forced to take for granted. Sadly, it was only very recently that I finally felt like I truly understood this constant. Sure, I knew some _facts_ about $e$, but I didn't really understand its _essence_. For example, I knew that 
