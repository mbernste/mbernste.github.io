...
To perform a graph-level task, such as classifying graphs, we need to aggregate information across nodes. A simple way to do this is to perform a simple aggregation step where we aggregate all of the vectors associated with each node 

<center><img src="https://raw.githubusercontent.com/mbernste/mbernste.github.io/master/images/GCN_graph_pool_vectors.png" alt="drawing" width="500"/></center>
