...
In the next sections we will dig deeper into the graph convolutional layer and discuss how the per-node embeddings can be combined for graph-wide tasks.
