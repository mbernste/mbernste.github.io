...
Note, GCNs can also perform edge level tasks as well, but we will not discuss this here. See [this article by Sanchez-Lengeling  _et al_. (2021)](https://distill.pub/2021/gnn-intro/) for a discussion on these various tasks. 
