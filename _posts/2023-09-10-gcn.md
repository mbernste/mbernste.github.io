...
<center><img src="https://raw.githubusercontent.com/mbernste/mbernste.github.io/master/images/GCN_stacked_layers.png" alt="drawing" width="600"/></center>
...
$$\begin{align*}\bar{\boldsymbol{x}}_i = \sum_{j=1}^n \frac{1}{d_{i,i}}a_{i,j} \boldsymbol{x}_j$$
