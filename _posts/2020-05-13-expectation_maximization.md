...
*Expectation-maximization (EM) is a popular algorithm for performing maximum-likelihood estimation for the parameters in a latent variable model. In this post, I discuss some theory behind, and intuition into, this algorithm.*
