...
This function, $\phi$, is often called the **feature map** as it maps our objects in $\mathcal{X}$ to a new "features" in the RKHS.  Now, one may ask what exactly are these features?  That is, what is this new representation of each $x \in \mathcal{X}$?  TODO!!!!!!!
