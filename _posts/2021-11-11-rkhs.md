...
Let's keep this in mind as we look at the axioms of a RKHS. Specifically, we note that the axiom of RKHS holds that the evaluation functional $\lamba(x)$ is continuous. The definition of continuity at a given $g \in \mathcal{H}$ is the following: 
