...
This is proven in Theorem 1 in the Appendix to this post. What it tells us is that if we have functions that are nearby eachother in the Hilbert space, then XXXXXXX. This is illustrated in the figure below:
