...
In fact, as we show in a [later post](https://mbernste.github.io/posts/matrices_linear_transformations/), such a matrix-defined function is a [linear function](https://mbernste.github.io/posts/matrices_linear_transformations/).  Even more importantly, *any* linear function between finite-dimensional vector spaces is uniquely defined by some matrix.
