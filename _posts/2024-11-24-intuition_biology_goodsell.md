...
First, despite the cell being so crowded, molecules move extremely fast within the cell. Our intuition, based on the macroscale in which we live, breaks down at at the subcellular scale. To try to grow some new intuition, let's look at the numbers. 
