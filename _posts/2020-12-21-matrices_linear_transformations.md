...
<span style="color:#0060C6">**Theorem 2 (Standard matrix of a linear transformations):** Given a linear transformation $T: \mathbb{R}^m \rightarrow \mathbb{R}^n$, it holds that </span>
