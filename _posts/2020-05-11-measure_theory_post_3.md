...
<span style="color:#0060C6">where $\mathbb{I}_{A_i}(x)$ is an indicator function such that 
  ...
  $\mathbb{I}_{A_i}(x) := 1$ if $x \in A_i$ and $\mathbb{I}_{A_i}(x) := 0$ otherwise.</span>
...
<span style="color:#0060C6">for some integer $n$, and the $\mathcal{H}$ generated by all of the singleton-subsets of $H$ with  pre-images</span>
