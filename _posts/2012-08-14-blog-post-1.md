...
<span style="color:#0060C6">$$\mu : \mathcal{F} \rightarrow \mathbb{R}$$</span>

<span style="color:#0060C6">is a **measure** if the following properties hold for $\mu$:</span>
1. <span style="color:#0060C6">Nonnegative: </span>

<span style="color:#0060C6">$$\forall A \in \mathcal{F}, \mu(A) \geq 0$$</span>
