...
<span style="color:#0072EA">**Definition 1**: A **probability space** is a measure space ($\Omega$, $E$, $P$) where $P(\Omega) = 1$ where </span>
1. <span style="color:#0072EA">The set $\Omega$, is called the **sample space**.</span>
2. <span style="color:#0072EA">The sigma-algebra over $\Omega$, denoted $E$, called the set of **events**.</span>
3. <span style="color:#0072EA">The measure $P$ for the measureable space $(\Omega, E)$ is the **probability measure**.</span>
