...
2. <span style="color:#0060C6">Empty set has zero measure: $\mu(\emptyset)= 0$ </span>
3. <span style="color:#0060C6">Countable additivity: Given $A, B \in \mathcal{F}$ where $A \cap B = \emptyset$, it holds that $\mu(A \cup B) = \mu(A) + \mu(B)$</span>
...
<center><img src="https://raw.githubusercontent.com/mbernste/mbernste.github.io/master/images/measure.png" alt="drawing" width="400"/></center>
