...
<span style="color:#0F7AEB">1. The set $\Omega$, is called the **sample space**.</span>
<span style="color:#0F7AEB">2. The sigma-algebra over $\Omega$, denoted $E$, called the set of **events**.</span>
<span style="color:#0F7AEB">3. The measure $P$ for the measureable space $(\Omega, E)$ is the **probability measure**.</span>
