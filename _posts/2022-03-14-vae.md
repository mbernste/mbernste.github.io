...
Now, let's say we are given a dataset consisting of data points $\boldsymbol{x}_1, \dots, \boldsymbol{x}_m \in \mathbb{R}^D$ that were generated by a VAE. We may be interested in two tasks:
