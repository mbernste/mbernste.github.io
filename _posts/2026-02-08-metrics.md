...
In this situation, the metric $f$ is _proportional_ to $V$. That is $V(x) = cf(x)$ for some unknown constant $c$. Because $c$ is unknown, it is impossible to know _exactly_ when one has succeeded at achieving a sufficient value of $V$; however, one can confidently track progress.
