...
Notably, however, the two functions may not have the same shape. One function may be flattening while the other is accelerating upward:
...
All that matters in this situation is that $f$ follows the same direction as $V$.

I would argue that this scenario is the most common. 
